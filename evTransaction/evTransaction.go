...
func (s *SmartContract) initLedger(APIstub shim.ChaincodeStubInterface) sc.Response {
	transDetails := []SwapTransactions{
		SwapTransactions{BatteryID: "BAT3", BatteryUsage: "30", EVOwnerID: "User1", TotalBill: "50", SwapAmount: "0", Date: "20/12/2020", Status: "Success"},
		SwapTransactions{BatteryID: "BAT5", BatteryUsage: "10", EVOwnerID: "User2", TotalBill: "50", SwapAmount: "10", Date: "25/12/2020", Status: "Success"},
	}
...
func (s *SmartContract) addTransaction(APIstub shim.ChaincodeStubInterface, args []string) sc.Response {
	...
	var swapTransactionDetails = SwapTransactions{BatteryID: args[1], BatteryUsage: args[2], EVOwnerID: args[3], TotalBill: "100", SwapAmount: "0", Date: args[4], Status: "Pending"}
